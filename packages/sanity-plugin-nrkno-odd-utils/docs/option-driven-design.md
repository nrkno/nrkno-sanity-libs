...
In itself, this is problematic, because it will lead to an infinite recursion; FormBuilderInput will resolve 
...
NestedFormBuilder is an extension of FormBuilderInput. It should be used in place of FormBuilderInput, 
whenever we create "decorator" components like the one described above. 
...
When creating a new, reusable component in nrkno-sanity, prefer the following approach:
